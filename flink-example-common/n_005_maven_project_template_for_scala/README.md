...
#### maven 生成Flink基本依赖
```aidl
mvn archetype:generate -DarchetypeGroupId=org.apache.flink -DarchetypeArtifactId=flink-quickstart-scala -DarchetypeVersion=1.9.1  -DgroupId=opensourceteams -DartifactId=flink-example-scala -Dversion=0.1 -Dpackage=com.opensourceteams.bigdata.flink.example -DinteractiveMode=false
